...
### Key Features:
* **Interactive Navigation:** Implemented a synchronized sidebar menu to navigate seamlessly between Home (*Portada*), Inflows (*Ingresos*), and Outflows (*Gastos*).
...
└── Finance_Dashboard.pbix # Full Power BI workbook file
